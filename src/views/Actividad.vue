  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Conectando conceptos y definiciones
        p.mb-4 Reforzar la comprensión de los principios fundamentales de la Programación Orientada a Objetos y familiarizarse con la terminología específica de POO en Java.
